      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <FormField label="Co-Borrower Name" className="col-span-2 sm:col-span-1">
              <input
                ...
                value={form.borrowerName2}
                onChange={(e) => set('borrowerName2', e.target.value)}
                className={inputClass}
              />
            </FormField>
        ...
        <div className="flex items-center justify-end gap-2 pt-1 border-t border-slate-100">
          <button
            ...
            onClick={handleClose}
            disabled={submitting}
            className="px-4 py-1.5 text-xs font-medium text-slate-600 bg-white border border-slate-200 rounded-md hover:bg-slate-50 transition-colors disabled:opacity-50"
          >
            Cancel
          </button>
          <button
            type="submit"
            disabled={submitting}
            className="px-4 py-1.5 text-xs font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 transition-colors disabled:opacity-60 flex items-center gap-1.5"
          >
            {submitting && (
